...
export class LoginModal extends HTMLElement {
    ...
    connectedCallback() {
        this.overlay = this.shadow.getElementById('login-modal');
        this.form = this.shadow.getElementById('auth-form');
        ...
        this.form.addEventListener('submit', async (e) => {
            ...
            const confirmPasswordEl = this.shadow.getElementById('confirm-password');
            const errorE = this.shadow.getElementById('error-message');
