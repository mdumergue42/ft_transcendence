...
export class AppDef extends HTMLElement {
	...
	async connectedCallback() {
		...
		<app-chat></app-chat>
		<main class="PText ml-[80px] min-h-screen bg-black overflow-x-hidden relative font-mono">
			...
			<div class="PBoxBorder PText bg-black border-b-2 p-2 font-mono text-xs">
