export class AppMatch extends HTMLElement {
	...
	menu() {
		...
		<div class="p-4">
			...
			<button id="select-mm" style="width:100%; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide">
			> 1. ONLINE PVP
			</button>

			<button id="select-ai" style="width:100%; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide">
			> 2. FIGHT AGAINST ARTIFICIAL INTELLIGENCE
			</button>

			<button id="select-pvp" style="width:100%; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide mt-1">
			> 3. PLAYER VS PLAYER BATTLE
			</button>

			<button id="select-tr" style="width:100%; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide mt-1">
			> 4. ONLINE TOURNAMENT
			</button>

			<button id="select-cancel" style="width:100%;display:none; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide mt-1">
			> CANCEL
			</button>

			<button id="select-start" style="width:100%;display:none; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide mt-1">
			> START TOURNAMENT
			</button>

			<div id="select-list-tr" style="margin-top:40px;width:100%;display:none; text-align: left;" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-200 uppercase tracking-wide mt-1">
	...
	case(id:string) {
		return `
		<div id="${id}" class="block p-3 border border-green-400/50 bg-black/50 text-green-400 relative">
			...
			<div class="text-center" style="display: grid; grid-template-columns: auto auto auto; grid-gap: 20px; height:100%; padding: 40px">
				...
				<div style="display: grid; grid-template-rows: repeat(7, 1fr); height:100%; grid-template-columns: 100%">
					<div style="grid-row: 4 / 5; ">
						<div class="block p-3 border border-green-400/50 bg-green-400 text-black relative">
	...
	async connectedCallback() {
		...
		<div class="border-2 border-green-400 bg-black" id="pong-interface" style="margin-top: 8px;width:988px; height:540px">
